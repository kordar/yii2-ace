...
class AceAsset extends AssetBundle
{
    ...
    public $sourcePath = '@vendor/kordar/yii2-ace/src/assets/ace/assets';
    ...
    {
        $viewObj = parent::register($view); // TODO: Change the autogenerated stub
        \Yii::$app->params['aceBaseUrl'] = $viewObj->baseUrl . '/';
        return $viewObj;
    }
